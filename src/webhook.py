...
class WebhookDelivery:
    ...
    def __init__(self, webhook_url: str, max_retries: int = 3, backoff_seconds: int = 10):
    ...
    def send(self, payload: Dict[str, Any]) -> bool:
        ...
        for attempt in range(1, self.max_retries + 1):
            try:
                ...
                logger.info("Webhook delivery successful (attempt %d/%d)", attempt, self.max_retries)
                return True
                ...
                if attempt < self.max_retries:
                    ...
                    logger.error("Webhook delivery failed after %d attempts", self.max_retries)
                    return False
